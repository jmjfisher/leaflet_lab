...
function crestWiki(rank){
    if (rank === 1){
        ...
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/4/47/FC_Barcelona_%28crest%29.svg/220px-FC_Barcelona_%28crest%29.svg.png";
        return url;
    }else if (rank === 3){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/165px-Real_Madrid_CF.svg.png";
        return url;
    }else if (rank === 4){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg/220px-FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg.png";
        return url;
    }else if (rank === 5){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/e/eb/Manchester_City_FC_badge.svg/200px-Manchester_City_FC_badge.svg.png";
        return url;
    }else if (rank === 6){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/5/53/Arsenal_FC.svg/180px-Arsenal_FC.svg.png";
        return url;
    }else if (rank === 7){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/c/cc/Chelsea_FC.svg/200px-Chelsea_FC.svg.png";
        return url;
    }else if (rank === 8){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/0/0c/Liverpool_FC.svg/170px-Liverpool_FC.svg.png";
        return url;
    }else if (rank === 9){
        var url = "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Juventus_FC_2017_logo.svg/110px-Juventus_FC_2017_logo.svg.png";
        return url;
    }else if (rank === 10){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/b/b4/Tottenham_Hotspur.svg/125px-Tottenham_Hotspur.svg.png";
        return url;
    }else if (rank === 11){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/a/a7/Paris_Saint-Germain_F.C..svg/200px-Paris_Saint-Germain_F.C..svg.png";
        return url;
    }else if (rank === 12){
        var url = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Borussia_Dortmund_logo.svg/220px-Borussia_Dortmund_logo.svg.png";
        return url;
    }else if (rank === 13){
        var url = "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Logo_of_AC_Milan.svg/150px-Logo_of_AC_Milan.svg.png";
        return url;
    }else if (rank === 14){
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/f/f4/Atletico_Madrid_2017_logo.svg/170px-Atletico_Madrid_2017_logo.svg.png";
        return url;
    }else{
        var url = "https://upload.wikimedia.org/wikipedia/en/thumb/c/c2/West_Ham_United_FC_logo.svg/185px-West_Ham_United_FC_logo.svg.png";
        return url;
    }
};
